...
class WC_Gateway_Custom_Lomi_Blocks_Support extends AbstractPaymentMethodType {

	/**
	 * Initializes the payment method type.
	 */
	public function initialize() {
		$lomi_gateway_settings        = get_option( 'woocommerce_lomi_settings', array() );
		$custom_lomi_gateway_settings = get_option( "woocommerce_{$this->name}_settings", array() );

		$this->settings = wp_parse_args( $custom_lomi_gateway_settings, $lomi_gateway_settings );
	...
	public function get_payment_method_script_handles() {
		...
		$script_url = plugins_url( "/assets/js/blocks/frontend/blocks/{$this->name}.js", WC_LOMI_MAIN_FILE );
