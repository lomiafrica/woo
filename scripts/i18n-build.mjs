...
const translations = {
	...
	'Allowed Banks Card': 'Cartes bancaires autorisees',
	'Allowed Card Brands': 'Marques de carte autorisees',
	'A flat fee to charge the subaccount for this transaction, in Naira (&#8358;). This overrides the split percentage set when the subaccount was created. Ideally, you will need to use this if you are splitting in flat rates (since subaccount creation only allows for percentage split). e.g. 100 for a &#8358;100 flat fee.': 'Frais fixes a facturer au sous-compte pour cette transaction, en naira (&#8358;). Cela remplace le pourcentage de repartition defini lors de la creation du sous-compte. Utilisez cette option si vous effectuez une repartition en montants fixes (la creation de sous-compte ne permet qu\'une repartition en pourcentage), par exemple 100 pour des frais fixes de &#8358;100.',
	...
	'Create additional custom lomi. based gateways. This allows you to create additional lomi. gateways using custom filters. You can create a gateway that accepts only verve cards, a gateway that accepts only bank payment, a gateway that accepts a specific bank issued cards.': 'Creez des passerelles lomi. personnalisees supplementaires avec des filtres dedies. Vous pouvez creer une passerelle qui accepte uniquement les cartes Verve, les paiements bancaires, ou les cartes emises par une banque specifique.',
	...
	'Debit/Credit Cards': 'Cartes de debit/credit',
	...
	'Lomi Africa': 'Lomi Africa',
	'Lomi for WooCommerce': 'Lomi pour WooCommerce',
	'lomi.': 'lomi.',
	'lomi. ': 'lomi. ',
	'lomi. - %s': 'lomi. - %s',
	'lomi.: amount mismatch (order expects %1$d minor units; session has %2$d).': 'lomi.: montant different (la commande attend %1$d unites mineures; la session contient %2$d).',
	...
	'lomi. Ghana': 'lomi. Ghana',
	'lomi. Nigeria': 'lomi. Nigeria',
	'lomi. Payment Gateway Disabled: %s': 'Passerelle de paiement lomi. desactivee: %s',
	'Make payment using your debit and credit cards': 'Payez avec vos cartes de debit et de credit',
	...
	'Settings': 'Reglages',
	'Select banks': 'Selectionner les banques',
	...
	'The banks whose card should be allowed for this gateway. This filter only works with the card payment channel.': 'Les banques dont les cartes doivent etre autorisees pour cette passerelle. Ce filtre fonctionne uniquement avec le canal de paiement par carte.',
...
function header(projectId, language = '') {
	return [
		'Project-Id-Version: Lomi for WooCommerce 6.0.0\\n',
		`Report-Msgid-Bugs-To: https://github.com/alphajoop/woocommerce/issues\\n`,
		`POT-Creation-Date: ${new Date().toISOString()}\\n`,
		`PO-Revision-Date: ${new Date().toISOString()}\\n`,
		'Last-Translator: Lomi Africa\\n',
		'Language-Team: Lomi Africa\\n',
...
function buildPot(messages) {
	let output = '# Copyright (C) 2026 Lomi Africa\n';
