...
lomi. for WooCommerce allows your WooCommerce store to accept secure payments from multiple local and global payment channels.

== Description ==

lomi. makes it easy for businesses in Nigeria, Ghana, Kenya and South Africa to accept secure payments from multiple local and global payment channels. Integrate lomi. with your store today, and let your customers pay you with their choice of methods.

With lomi. for WooCommerce, you can accept payments via:
...
* Modern, seamless payment experience via the lomi. Checkout — [Try the demo!](https://lomi.com/demo/checkout)
...
Over 60,000 businesses of all sizes in Nigeria, Ghana, Kenya, and South Africa rely on lomi.'s suite of products to receive payments and make payouts seamlessly. Sign up on [lomi..com/signup](https://lomi.com/signup) to get started.
...
*	No subscription plans is created on lomi.. The [WooCommerce Subscriptions](https://woocommerce.com/products/woocommerce-subscriptions/) plugin handles all the subscription functionality.
...
= lomi. Setup and Configuration =
*   Go to __WooCommerce > Settings__ and click on the __Payments__ tab
*   You'll see lomi. listed along with your other payment methods. Click __Set Up__
*   On the next screen, configure the plugin. There is a selection of options on the screen. Read what each one does below.

1. __Enable/Disable__ - Check this checkbox to Enable lomi. on your store's checkout
2. __Title__ - This will represent lomi. on your list of Payment options during checkout. It guides users to know which option to select to pay with lomi.. __Title__ is set to "Debit/Credit Cards" by default, but you can change it to suit your needs.
3. __Description__ - This controls the message that appears under the payment fields on the checkout page. Use this space to give more details to customers about what lomi. is and what payment methods they can use with it.
...
5. __Payment Option__ - Select how lomi. Checkout displays to your customers. A popup displays lomi. Checkout on the same page, while Redirect will redirect your customer to make payment.
6. __API Keys__ - The next two text boxes are for your lomi. API keys, which you can get from your lomi. Dashboard. If you enabled Test Mode in step four, then you'll need to use your test API keys here. Otherwise, you can enter your live keys.
7. __Additional Settings__ - While not necessary for the plugin to function, there are some extra configuration options you have here. You can do things like add custom metadata to your transactions (the data will show up on your lomi. dashboard) or use lomi.'s [Split Payment feature](https://lomi.com/docs/payments/split-payments). The tooltips next to the options provide more information on what they do.
8. Click on __Save Changes__ to update the settings.

To account for poor network connections, which can sometimes affect order status updates after a transaction, we __strongly__ recommend that you set a Webhook URL on your lomi. dashboard. This way, whenever a transaction is complete on your store, we'll send a notification to the Webhook URL, which will update the order and mark it as paid. You can set this up by using the URL in red at the top of the Settings page. Just copy the URL and save it as your webhook URL on your lomi. dashboard under __Settings > API Keys & Webhooks__ tab.

If you do not find lomi. on the Payment method options, please go through the settings again and ensure that:
...
*   A lomi. merchant account—use an existing account or [create an account here](https://lomi.com/signup)
...
*	No subscription plans is created on lomi.. The [WooCommerce Subscriptions](https://woocommerce.com/products/woocommerce-subscriptions/) handles all the subscription functionality.
...
= 5.8.2 - July 18, 2024 =
*   New: Introduce filter hook `wc_lomi_payment_channels`
...
*   Improve: Ensure order amount is in integer when initializing payment on lomi.
...
*   Update: Load lomi. InlineJS (Popup) V2 in the custom payment gateways

= 5.7.6 - June 20, 2023 =
*   New: Minimum WooCommerce supported version: 7.0
*   Fix: Unable to process refund on the view order screen
*   Improve: lomi. test mode notice will now be displayed in the WooCommerce Admin Notes Inbox

= 5.7.5 - May 22, 2023 =
*   Update: Add support for EGP as an accepted currency
*   Update: Update icon for Kenyan payment methods
*   Update: Migrate to lomi. InlineJS (Popup) V2
...
*   Fix: lomi. payment modal displaying on the "Pay for Order" page
...
= 5.7.2 - March 12, 2021 =
* New: Auto display lomi. payment popup on the payment page
* Removed: Remove lomi. metrics tracker
...
* Fix: The default gateway should display only the payment channel(s) set on the lomi. settings page
...
= 5.6.0 - August 7, 2019 =
*   New: Support for refunds via lomi. from the order details screen.
*   New: Log successful transaction to lomi. metrics tracker.
*   New: Add support for sending additional order details to lomi. when making payment using a saved card.
*   New: Add support for sending additional order details to lomi. when a subscription payment is renewed.
...
*   Misc: Remove lomi. fee and lomi. payout amount on the order details page
...
*   New: Add support for lomi. split payments
*   New: Display lomi. fee and lomi. payout amount on the order details page
...
*	Fix: Deprecated functions in the Tbz_WC_Gateway_Lomi_Subscription class
...
*	New: Add support for lomi. custom filters
*	New: Create additional lomi. gateways (max of 5) using different custom filters. You can create a gateway that accepts only Verve cards, a gateway that accepts only bank account payments, a gateway that accepts only GTB issued Mastercard.
...
= 4.0.0 - April 10, 2017 =
* 	New: Add support for lomi. Inline Embed.
*  	New: Add support for sending additional order details to lomi.

= 3.1.1 - February 13, 2017 =
* 	New: Changed lomi. payment methods icon.

= 3.1.0 - January 10, 2017 =
* 	New: Add support for USD and GBP currency. Note this has to be enabled by lomi. for your account before it can be used on your site.
...
= 1.1.0 - April 22, 2016 =
*   Fix: Fatal error if the WooCommerce plugin is deactivated while the lomi. plugin is active
